...
//	    }
	...
	public static String reqpam(String messageType,String orderInfo,int[] arr,List<String> lists){
		JsonObject json=new JsonObject();
		JsonArray jArray=new JsonArray();
		for(int i=0;i<arr.length;i++){
			JsonObject temp=new JsonObject();
...
//		}
	...
	public static String getPam(String messageType,String orderInfo,Map<String,String> map){
		JsonObject json=new JsonObject();
		JsonArray jArray=new JsonArray();
//		for(int i=0;i<map.keySet().size();i++){
//			JsonObject temp=new JsonObject();
